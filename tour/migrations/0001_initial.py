    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='country_img/', verbose_name='Картинка превью')),
                ('imageHeader', models.ImageField(null=True, upload_to='country_img/', verbose_name='Картинка для шапки')),
                ('name', models.CharField(max_length=100, null=True, verbose_name='Страна')),
                ('isPopular', models.BooleanField(default=False, verbose_name='Показывать в популярных направлениях ?')),
                ...
                ('shortDescription', models.CharField(blank=True, max_length=80, null=True, verbose_name='Короткое описание (80 символов)')),
            ],
            options={
                'verbose_name': 'Страна',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nameLower', models.CharField(db_index=True, max_length=100, null=True)),
                ...
                ('isSpecial', models.BooleanField(default=False, verbose_name='Показывать в специальных турах на главной ?')),
                ('isPopular', models.BooleanField(default=False, verbose_name='Показывать в популярных турах на главной?')),
                ('badge', models.CharField(blank=True, max_length=10, null=True, verbose_name='Бейдж тура (выводится на карточке специального или популярного тура)')),
                ...
                ('rating', models.IntegerField(default=0, verbose_name='Рейтинг тура (в звездочках) от 1 до 5, если 0 - не отображается')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tour.Country', verbose_name='Страна')),
            ],
            options={
                'verbose_name': 'Тур',
        ...
        migrations.AddField(
            model_name='tour',
            name='tag',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tour.Tag', verbose_name='Тег'),
        ),
        migrations.AddField(
            model_name='tour',
            name='variant',
